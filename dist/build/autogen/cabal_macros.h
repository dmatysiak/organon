...
/* package teflog-0.1.0.0 */
#define VERSION_teflog "0.1.0.0"
#define MIN_VERSION_teflog(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "teflog-0.1.0.0-GBtckeIHRME1W2dtwhHRF6"

#define CURRENT_PACKAGE_KEY "teflog-0.1.0.0-GBtckeIHRME1W2dtwhHRF6"
